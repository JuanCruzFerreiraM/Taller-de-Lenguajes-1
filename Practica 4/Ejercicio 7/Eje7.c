...
void inicializarLista(lista **l)
{
    ...
    lista *actual = NULL;
    int elemento;
    printf("Ingrese un valor entero positivo, para finalizar ingrese 0\n");
    scanf("%d", &elemento);
    while (elemento != 0)
    {
        if (elemento > 0)
        ...
        {
            printf("El valor ingresado no es un entero positivo, ingrese un valor diferente, para finalizar ingrese 0\n");
            scanf("%d", &elemento);
        }
    }
    *l = actual;
